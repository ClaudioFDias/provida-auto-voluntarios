...
def conflito_dialog(evento_nome, horario):
    st.warning(f"⚠️ **Não é possível realizar a inscrição.**")
    st.write(f"Você já está inscrito em outro evento neste mesmo horário:")
    st.info(f"📌 **{evento_nome}** às **{horario}**")
